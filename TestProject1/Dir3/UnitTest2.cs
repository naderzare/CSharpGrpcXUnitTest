...
namespace TestProject1.Dir3
{
    ...
    public class UnitTest2 : TestFixture, IDisposable
    {
        public UnitTest2(ITestOutputHelper testOutputHelper): base(testOutputHelper)
        {
        }
        ...
        public void Test1()
        {
            ...
            _testOutputHelper.WriteLine($"UnitTest2.Test1: {reply4.Count}");
            Assert.Equal(1, reply4.Count);

            var reply5 = client.GetUsers(new GetUsersRequest());
            _testOutputHelper.WriteLine($"UnitTest2.Test1: {reply5.Users}");
        ...
        public void Test2()
        {
            ...
            var reply4 = client.GetUsersCount(new GetUsersCountRequest());
            _testOutputHelper.WriteLine($"UnitTest2.Test2: {reply4.Count}");
            Assert.Equal(1, reply4.Count);

            var reply5 = client.GetUsers(new GetUsersRequest());
            _testOutputHelper.WriteLine($"UnitTest2.Test2: {reply5.Users}");
        ...
        public void Test4()
        {
            ...
            var reply4 = client.GetUsersCount(new GetUsersCountRequest());
            _testOutputHelper.WriteLine($"UnitTest2.Test4: {reply4.Count}");
            Assert.Equal(1, reply4.Count);

            var reply5 = client.GetUsers(new GetUsersRequest());
            _testOutputHelper.WriteLine($"UnitTest2.Test4: {reply5.Users}");
        ...
        public void Test3()
        {
            ...
            var reply4 = client.GetUsersCount(new GetUsersCountRequest());
            _testOutputHelper.WriteLine($"UnitTest2.Test3: {reply4.Count}");
            Assert.Equal(1, reply4.Count);

            var reply5 = client.GetUsers(new GetUsersRequest());
            _testOutputHelper.WriteLine($"UnitTest2.Test3: {reply5.Users}");
        ...
        public void Test5()
        {
            ...
            var reply4 = client.GetUsersCount(new GetUsersCountRequest());
            _testOutputHelper.WriteLine($"UnitTest2.Test5: {reply4.Count}");
            Assert.Equal(1, reply4.Count);

            var reply5 = client.GetUsers(new GetUsersRequest());
            _testOutputHelper.WriteLine($"UnitTest2.Test5: {reply5.Users}");
